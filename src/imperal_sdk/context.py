...
if TYPE_CHECKING:
    from imperal_sdk.types.models import (
        ...
        SetupIntentResult, ChangePlanResult, TopupResult, AutoTopupSettings,
    )
...
class BillingProtocol(Protocol):
    ...
    async def topup(self, tokens: int, price_cents: int, save_payment_method: bool = True, off_session: bool = True, user: Any = None) -> TopupResult: ...
