...
# Sprint C 2026-05-06 (v4.1.3) hygiene split: retry helpers moved.
# Public API unchanged — these names continue to be importable from
# imperal_sdk.chat.handler for back-compat with kernel callers and
...
# v5-27 god-file split (2026-05-14): `_execute_function` extracted to
# imperal_sdk.chat.execution. Public + module-internal callers continue
# to import it from this module for back-compat.
from imperal_sdk.chat.execution import _execute_function  # noqa: F401
